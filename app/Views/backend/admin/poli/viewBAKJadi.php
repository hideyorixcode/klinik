                    ...
                    <table class="table table-bordered table-striped mb-0" id="hideyori-datatable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-xs btn-danger" type="button" onclick="bulk_delete()"><i
                                            class="fas fa-trash"></i> Hapus Pilihan
                                    </button>
                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="modal-title w-100" id="gantijudul">Form Poli</h3>
