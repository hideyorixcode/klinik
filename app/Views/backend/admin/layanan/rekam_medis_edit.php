    ...
    <div class="row">
        <div class="col-lg-12 col-xl-12">
            <form id="form" name="form" method="post" class="p-3" enctype="multipart/form-data"
                  action="<?= base_url('dashboard/layanan/update-rekam') ?>" class="form-horizontal">
                <?= csrf_field() ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="tgl_berobat"
                                       ...
                                       value="<?= old('tgl_berobat') ? old('tgl_berobat') : TanggalIndo2($dataMaster['tgl_berobat']); ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="subyektif" name="subyektif" required
                                       ...
                                       value="<?= old('subyektif') ? old('subyektif') : $dataMaster['subyektif'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="obyektif" name="obyektif" required
                                       ...
                                       value="<?= old('obyektif') ? old('obyektif') : $dataMaster['obyektif'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="assesment" name="assesment" required
                                       ...
                                       value="<?= old('assesment') ? old('assesment') : $dataMaster['assesment'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="planning" name="planning" required
                                       ...
                                       value="<?= old('planning') ? old('planning') : $dataMaster['planning'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="keterangan_rm" name="keterangan_rm"
                                       ...
                                       value="<?= old('keterangan_rm') ? old('keterangan_rm') : $dataMaster['keterangan_rm'] ?>">
                                <div class="invalid-feedback">
