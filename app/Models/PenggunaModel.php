...
class PenggunaModel extends Model
{
    ...
    protected $allowedFields = ['username', 'nama', 'password', 'notelepon', 'avatar', 'email', 'active', 'level', 'id_poli_fk', 'alamat', 'jk', 'tgl_lahir', 'deskripsi', 'gol_darah', 'tinggi_badan', 'berat_badan', 'bpjs', 'pekerjaan', 'agama', 'nama_kk', 'created_at', 'updated_at'];
    protected $request;
    protected $db;
    protected $dt;
