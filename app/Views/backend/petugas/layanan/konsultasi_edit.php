            ...
            <section class="card card-secondary">
                ...
                <div class="card-body">
                    <form id="form" name="form" method="post" class="p-3" enctype="multipart/form-data"
                          action="<?= base_url('dashboard/layanan/update-konsultasi') ?>" class="form-horizontal">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="nomor_konsultasi" name="nomor_konsultasi"
                                       ...
                                       value="<?= old('nomor_konsultasi') ? old('nomor_konsultasi') : $dataMaster['nomor_konsultasi'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="tgl_konsultasi"
                                       ...
                                       value="<?= old('tgl_konsultasi') ? old('tgl_konsultasi') : TanggalIndo2($dataMaster['tgl_konsultasi']); ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="diagnosis" name="diagnosis" required
                                       ...
                                       value="<?= old('diagnosis') ? old('diagnosis') : $dataMaster['diagnosis'] ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="saran" name="saran" required
                                       ...
                                       value="<?= old('saran') ? old('saran') : $dataMaster['saran'] ?>">
                                <div class="invalid-feedback">
                ...
                <footer class="card-footer">
                    <div class="row justify-content-end text-right">
                        <div class="col-sm-12">
                            <a class="btn btn-success" href="<?= base_url('print-konsultasi/' . $id) ?>"
                               target="_blank"><i
                                        class="fa fa-print"></i>
                                Cetak Konsultasi
                            </a>
